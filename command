...
Steps for working on git
 ...
 5) git remote add origin repoName(path of git where we create repository) // For link our project to git repository 

6) git push origin master // For push our project to  repository and also we create new file the add that file we run this command
